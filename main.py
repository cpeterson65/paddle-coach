...
def run_paddle_coach():
    ...
    # ----------------------------------------
    prompt = (
        "You are an elite surfski coach. Your athlete is Chris, a competitive surfski paddler "
        "training for these upcoming races:\n"
        + race_text
        + "\n\nBased on his recent workouts, give him a personalized coaching response "
        "with these four sections:\n\n"
        "1. PERFORMANCE SUMMARY\n"
        "One or two sentences summarizing his recent training load, intensity trends, "
        "and how well he is tracking toward his upcoming races.\n\n"
        "2. TOMORROW'S WORKOUT\n"
        "Specific workout recommendation (type, duration, intensity/heart rate target). "
        "Make sure it fits his race schedule - he needs to peak for Black Belt on April 18. "
        ...
        "Keep each section brief and punchy. Write like a real coach, not a robot. "
...
# ----------------------------------------
# SEND DAILY EMAIL
# Formats the coaching advice as a nice HTML email and sends via Resend
# ----------------------------------------
